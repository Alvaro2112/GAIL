...
class Discriminator(nn.Module):
    def __init__(self, state_dim, action_dim, net_dim, lr, betas, expert, actor, update_batch_size):
        ...
        #self.discriminator3 = nn.Linear(net_dim[1], net_dim[2])
        self.discriminator4 = nn.Linear(net_dim[1], 1)
    ...
    def forward(self, pair):
        ...
        #x = torch.tanh(self.discriminator3(x))
        x = torch.sigmoid(self.discriminator4(x))
